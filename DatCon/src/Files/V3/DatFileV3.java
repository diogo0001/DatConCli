...
public class DatFileV3 extends DatFile {
    ...
    public DatFileV3(DatConPanel datCon) {
    	super(datCon);
    }

    public DatFileV3(DatConPanel datCon, String fileName) throws IOException, NotDatFile {
        super(datCon, fileName);
    }

    public DatFileV3(DatConPanel datCon, File _file) throws IOException, NotDatFile {
        super(datCon, _file);
    }

    @Override
    public ConvertDat createConvertDat(DatConPanel datCon) {
        return new ConvertDatV3(datCon, this);
    }
