...
public class DatFileV1 extends DatFile {
    ...
    public DatFileV1(DatConPanel datCon, String fileName) throws IOException, NotDatFile {
        //this(new File(fileName));
        super(datCon, fileName);
    }

    public DatFileV1(DatConPanel datCon, File _file) throws NotDatFile, FileNotFoundException {
        super(datCon, _file);
        //file = _file;
    ...
    public ConvertDat createConvertDat(DatConPanel datCon) {
        return (new ConvertDatV1(datCon, this));
    }
